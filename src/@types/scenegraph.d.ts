...
declare class ImageFill {
   ...
   */
  public constructor(fileOrDataURI: string | any)
...
declare abstract class SceneNode {
   ...
   */
  public placeInParentCoordinates(registrationPoint: Point, parentPoint: Point): void
...
declare class GraphicsNode extends SceneNode {
   ...
   */
  public fill: null | Color | LinearGradientFill | RadialGradientFill | ImageFill
...
declare class Line extends GraphicsNode {
   ...
   * @param {number} endY
   */
  public setSTartEnd(startX: number, startY: number, endX: number, endY: number): void
}
